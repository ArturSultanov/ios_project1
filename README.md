...
Předpokládejte, že ukázky chování v bodech 2 až 6 jsou na sobě nezávislé a každá z nich navazuje přímo na ukázku č. 1. Tedy například důsledky ukázky č. 2 se nepromítnou do výsledků ukázek č. 3, 4, atd. (UPDATED 21.3.)
